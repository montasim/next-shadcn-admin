...
const toPublicBook = (book: Book): PublicBook => ({
  ...
  purchaseDate: book.purchaseDate ? (typeof book.purchaseDate === 'string' ? book.purchaseDate : book.purchaseDate.toISOString()) : null,
  entryDate: book.entryDate ? (typeof book.entryDate === 'string' ? book.entryDate : book.entryDate.toISOString()) : undefined,
  image: book.image ?? null,
  fileUrl: book.fileUrl ?? null,
  directFileUrl: book.directFileUrl ?? null,
  aiSummary: book.aiSummary ?? null,
  aiSummaryGeneratedAt: book.aiSummaryGeneratedAt ? (typeof book.aiSummaryGeneratedAt === 'string' ? book.aiSummaryGeneratedAt : book.aiSummaryGeneratedAt.toISOString()) : null,
