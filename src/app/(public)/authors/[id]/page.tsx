              ...
              <div className="text-left space-y-3 max-w-md mx-auto">
                ...
                <ul className="text-sm text-muted-foreground space-y-2 ml-4">
                  <li className="flex items-start gap-2">
                    ...
                    <span>The author ID might be incorrect or mistyped</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-0.5">•</span>
                    <span>The author has been removed from our library</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-0.5">•</span>
                    <span>The author profile might be temporarily unavailable</span>
                  </li>
                </ul>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-6">
          ...
          <div className="lg:col-span-2">
            ...
            {author.books && author.books.length > 0 && (
              <div>
                <h2 className="text-xl font-bold mb-6">Books by {author.name}</h2>
                <BookGrid
                  books={author.books}
                  viewMode="grid"
